			...
			'home-top-widget-content-setup' => array(
				...
				'data'      => array(
					'home-top-widget-content-text'  => array(
						'label'     => __( 'Text', 'gppro' ),
						'input'     => 'color',
						'target'    => array( '.home-top .entry .entry-content', '.home-top .entry .entry-content p' ),
						'builder'   => 'GP_Pro_Builder::hexcolor_css',
						'selector'  => 'color',
					),
			...
			'home-middle-widget-content-setup' => array(
				...
				'data'      => array(
					'home-middle-widget-content-text'  => array(
						'label'     => __( 'Text', 'gppro' ),
						'input'     => 'color',
						'target'    => array( '.home-middle .entry .entry-content', '.home-middle .entry .entry-content p' ),
						'builder'   => 'GP_Pro_Builder::hexcolor_css',
						'selector'  => 'color',
					),
			...
			'home-bottom-widget-content-setup' => array(
				...
				'data'      => array(
					'home-bottom-widget-content-text'  => array(
						'label'     => __( 'Text', 'gppro' ),
						'input'     => 'color',
						'target'    => array( '.home-bottom .entry .entry-content', '.home-bottom .entry .entry-content p' ),
						'builder'   => 'GP_Pro_Builder::hexcolor_css',
						'selector'  => 'color',
					),
