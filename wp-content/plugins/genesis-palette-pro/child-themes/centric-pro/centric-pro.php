...
class GP_Pro_Centric_Pro {
	...
	public function set_defaults( $defaults ) {
		...
		$changes = array(
			...
			// home sections 6
			'home-section-six-back'                         => $color,

			// first and last widget padding
			'hs-six-widget-padding-top'                     => '140',
			'hs-six-widget-padding-bottom'                  => '140',
			'hs-six-widget-padding-left'                    => '0',
			'hs-six-widget-padding-right'                   => '0',

			// max-width: 1220px
			'hs-six-media-padding-top'                      => '80',
			'hs-six-media-padding-bottom'                   => '80',
			'hs-six-media-padding-left'                     => '0',
			'hs-six-media-padding-right'                    => '0',

			// max-width: 782px
			'hs-six-media-two-padding-top'                  => '60',
			'hs-six-media-two-padding-bottom'               => '60',
			'hs-six-media-two-padding-left'                 => '0',
			'hs-six-media-two-padding-right'                => '0',

			// widget title
			'home-section-six-title-text'                    => '#ffffff',
			'home-section-six-title-stack'                   => 'lato',
			'home-section-six-title-size'                    => '18',
			'home-section-six-title-weight'                  => '300',
			'home-section-six-title-transform'               => 'none',
			'home-section-six-title-align'                   => 'center',
			'home-section-six-title-style'                   => 'normal',

			// widget content
			'home-section-six-content-text'                  => '#ffffff',
			'home-section-six-content-stack'                 => 'lato',
			'home-section-six-content-size'                  => '18',
			'home-section-six-content-weight'                => '300',
			'home-section-six-content-align'                 => 'center',
			'home-section-six-content-style'                 => 'normal',
	...
	public function homepage_section( $sections, $class ) {
		...
		$sections['homepage'] = array(
			...
			// home section 6
			'section-break-home-section-six' => array(
				'break' => array(
					'type'  => 'full',
					'title' => __( 'Home Section 6', 'gppro' ),
					'text'  => __( 'This area is designed to display a text widget.', 'gppro' ),
				),
			),

			// background area settings
			'home-section-six-area-setup' => array(
				'title' => __( 'Area Setup', 'gppro' ),
				'data'      => array(
					'home-section-six-back'  => array(
						'label'     => __( 'Background Color', 'gppro' ),
						'input'     => 'color',
						'target'    => '.home-widgets-6',
						'builder'   => 'GP_Pro_Builder::rgbcolor_css',
						'selector'  => 'background-color',
						'rgb'       => true,
					),
			...
			// first and last widget padding
			'section-break-home-section-six-padding' => array(
				'break' => array(
					'type'  => 'full',
					'title' => __( 'General Widget Padding', 'gppro' ),
					'text'  => __( 'This section includes padding settings for different screensizes.', 'gppro' ),
			...
			// widget padding
			'home-section-six-padding-setup' => array(
				'title'     => __( 'General', 'gppro' ),
				'data'      => array(
					'hs-six-widget-padding-top'   => array(
						'label'     => __( 'Top', 'gppro' ),
						'input'     => 'spacing',
						'target'    => '.home-widgets-6 .widget:first-child',
						'builder'   => 'GP_Pro_Builder::px_css',
						'selector'  => 'padding-top',
						'min'       => '0',
						'max'       => '200',
					...
					'hs-six-widget-padding-bottom'    => array(
						'label'     => __( 'Bottom', 'gppro' ),
						'input'     => 'spacing',
						'target'    => '.home-widgets-6 .widget:last-child',
						'builder'   => 'GP_Pro_Builder::px_css',
						'selector'  => 'padding-bottom',
						'min'       => '0',
						'max'       => '200',
					...
					'hs-six-widget-padding-left'    => array(
						'label'     => __( 'Left', 'gppro' ),
						'input'     => 'spacing',
						'target'    => '.home-widgets-6 .widget',
						'builder'   => 'GP_Pro_Builder::px_css',
						'selector'  => 'padding-left',
						'min'       => '0',
						'max'       => '100',
					...
					'hs-six-widget-padding-right'    => array(
						'label'     => __( 'Right', 'gppro' ),
						'input'     => 'spacing',
						'target'    => '.home-widgets-6 .widget',
						'builder'   => 'GP_Pro_Builder::px_css',
			...
			// max-width: 1220px
			'home-section-six-media-padding-setup' => array(
				'title'     => __( '1220px screensize', 'gppro' ),
				'data'      => array(
					'hs-six-media-padding-top'   => array(
						'label'     => __( 'Top', 'gppro' ),
						'input'     => 'spacing',
						'target'    => '.home-widgets-6 .widget:first-child',
						'builder'   => 'GP_Pro_Builder::px_css',
					...
					'hs-six-media-padding-bottom'    => array(
						'label'     => __( 'Bottom', 'gppro' ),
						'input'     => 'spacing',
						'target'    => '.home-widgets-6 .widget:last-child',
						'builder'   => 'GP_Pro_Builder::px_css',
					...
					'hs-six-media-padding-left'    => array(
						'label'     => __( 'Left', 'gppro' ),
						'input'     => 'spacing',
						'target'    => '.home-widgets-6 .widget',
						'builder'   => 'GP_Pro_Builder::px_css',
					...
					'hs-six-media-padding-right'    => array(
						'label'     => __( 'Right', 'gppro' ),
						'input'     => 'spacing',
						'target'    => '.home-widgets-6 .widget',
						'builder'   => 'GP_Pro_Builder::px_css',
			...
			// max-width: 782px
			'home-section-six-media-two-padding-setup' => array(
				'title'     => __( '782px screensize', 'gppro' ),
				'data'      => array(
					'hs-six-media-two-padding-top'   => array(
						'label'     => __( 'Top', 'gppro' ),
						'input'     => 'spacing',
						'target'    => '.home-widgets-6 .widget:first-child',
						'builder'   => 'GP_Pro_Builder::px_css',
					...
					'hs-six-media-two-padding-bottom'    => array(
						'label'     => __( 'Bottom', 'gppro' ),
						'input'     => 'spacing',
						'target'    => '.home-widgets-6 .widget:last-child',
						'builder'   => 'GP_Pro_Builder::px_css',
					...
					'hs-six-media-two-padding-left'    => array(
						'label'     => __( 'Left', 'gppro' ),
						'input'     => 'spacing',
						'target'    => '.home-widgets-6 .widget',
						'builder'   => 'GP_Pro_Builder::px_css',
					...
					'hs-six-media-two-padding-right'    => array(
						'label'     => __( 'Right', 'gppro' ),
						'input'     => 'spacing',
						'target'    => '.home-widgets-6 .widget',
						'builder'   => 'GP_Pro_Builder::px_css',
			...
			// widget title settings
			'section-break-home-section-six-title' => array(
				'break' => array(
					'type'  => 'thin',
					'title' => __( 'Widget Title Area', 'gppro' ),
					'text' => __( 'These are optional settings, as the widget title is not used in the themes demo', 'gppro' ),
			...
			//	widget title settings
			'home-section-six-type-setup' => array(
				'title' => __( 'Typography', 'gppro' ),
				'data'      => array(
					'home-section-six-title-text'    => array(
						'label'     => __( 'Text', 'gppro' ),
						'input'     => 'color',
						'target'    => '.home-widgets-6 .widget-title',
						'builder'   => 'GP_Pro_Builder::hexcolor_css',
						'selector'  => 'color',
					),
					'home-section-six-title-stack'   => array(
						'label'     => __( 'Font Stack', 'gppro' ),
						'input'     => 'font-stack',
						'target'    => '.home-widgets-6 .widget-title',
						'builder'   => 'GP_Pro_Builder::stack_css',
					...
					'home-section-six-title-size'    => array(
						'label'     => __( 'Font Size', 'gppro' ),
						'input'     => 'font-size',
						'scale'     => 'text',
						'target'    => '.home-widgets-6 .widget-title',
					...
					'home-section-six-title-weight'  => array(
						'label'     => __( 'Font Weight', 'gppro' ),
						'input'     => 'font-weight',
						'target'    => '.home-widgets-6 .widget-title',
						'builder'   => 'GP_Pro_Builder::number_css',
					...
					'home-section-six-title-transform'   => array(
						'label'     => __( 'Text Appearance', 'gppro' ),
						'input'     => 'text-transform',
						'target'    => '.home-widgets-6 .widget-title',
						'builder'   => 'GP_Pro_Builder::text_css',
					...
					'home-section-six-title-align'   => array(
						'label'     => __( 'Text Alignment', 'gppro' ),
						'input'     => 'text-align',
						'target'    => '.home-widgets-6 .widget-title',
						'builder'   => 'GP_Pro_Builder::text_css',
					...
					'home-section-six-title-style'   => array(
						'label'     => __( 'Font Style', 'gppro' ),
						'input'     => 'radio',
						'options'   => array(
							array(
			...
			// widget content settings
			'section-break-home-section-six-content'  => array(
				'break' => array(
					'type'  => 'thin',
					'title' => __( 'Widget Content', 'gppro' ),
				),
			...
			// widget content settings
			'home-section-six-content-setup' => array(
				'title'     => '',
				'data'      => array(
					'home-section-six-content-text'  => array(
						'label'     => __( 'Text', 'gppro' ),
						'input'     => 'color',
						'target'    => '.home-widgets-6 .widget',
						'builder'   => 'GP_Pro_Builder::hexcolor_css',
					...
					'home-section-six-content-stack' => array(
						'label'     => __( 'Font Stack', 'gppro' ),
						'input'     => 'font-stack',
						'target'    => '.home-widgets-6 .widget',
						'builder'   => 'GP_Pro_Builder::stack_css',
					...
					'home-section-six-content-size'  => array(
						'label'     => __( 'Font Size', 'gppro' ),
						'input'     => 'font-size',
						'scale'     => 'text',
						'target'    => '.home-widgets-6 .widget',
					...
					'home-section-six-content-weight'    => array(
						'label'     => __( 'Font Weight', 'gppro' ),
						'input'     => 'font-weight',
						'target'    => '.home-widgets-6 .widget',
						'builder'   => 'GP_Pro_Builder::number_css',
					...
					'home-section-six-content-align' => array(
						'label'     => __( 'Text Alignment', 'gppro' ),
						'input'     => 'text-align',
						'target'    => '.home-widgets-6 .widget',
						'builder'   => 'GP_Pro_Builder::text_css',
					...
					'home-section-six-content-style' => array(
						'label'     => __( 'Font Style', 'gppro' ),
						'input'     => 'radio',
						'options'   => array(
							array(
