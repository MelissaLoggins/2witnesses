...
class GP_Pro_Digital_Pro {
	...
	public function set_defaults( $defaults ) {
		...
		$changes = array(
			...
			'site-title-link'                               => '#232525',
			'site-title-link-hov'                           => '#232525',
	...
	public function header_area( $sections, $class ) {
		...
		// Reset part of the site title area.
		$sections['site-title-text-setup']['data']['site-title-text']['label'] = __( 'Text Color', 'gppro' );
		$sections['site-title-text-setup']['data']['site-title-text']['target'] = '.site-title';

		// add targeted site title
		$sections['site-title-text-setup']['data'] = GP_Pro_Helper::array_insert_after(
			'site-title-text', $sections['site-title-text-setup']['data'],
			array(
				'site-title-link'  => array(
				...
				'site-title-link-hov'  => array(
					'label'    => __( 'Link Color', 'gppro' ),
					'sub'      => __( 'Hover', 'gppro' ),
					'input'    => 'color',
					'target'   => array( '.site-title a:hover', '.site-title a:focus' ),
					'selector' => 'color',
					'builder'  => 'GP_Pro_Builder::hexcolor_css',
				),
			)
