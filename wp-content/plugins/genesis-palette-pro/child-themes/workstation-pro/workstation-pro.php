...
class GP_Pro_Workstation_Pro {
	...
	private function __construct() {
		...
		// Enable the site description which is present even with a header image.
		add_filter( 'gppro_enable_site_description_options', '__return_true' );
	}
	...
	public function header_area( $sections, $class ) {
		...
		$sections['section-break-site-desc']['break']['text'] =__( 'The site description text is displayed prominently.', 'gppro' );
